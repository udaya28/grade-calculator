    ...
    return (
        <div className="header flex flex-row  items-center justify-between p-5">
            ...
            <div className="flex flex-row  items-center justify-end  basis-1/2">
                <nav className={`absolute right-6 top-20 ${isOpen && 'hidden'} md:static md:flex flex-row justify-between md:w-full mr-4`}>
                ...
                <div className='flex justify-end items-center'>
                    <button type='button' onClick={() => toggleDarkMode()}>
                        ...
                        <p className={`${!isDarkMode && 'hidden'} text-secondary  hover:text-primary hover:underline font-semibold mr-4`}>
